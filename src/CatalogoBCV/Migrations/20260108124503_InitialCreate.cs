    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CatalogDatabases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CatalogDatabaseId = table.Column<int>(type: "int", nullable: false),
                    Schema = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Type = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Alias = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsFactTable = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tables", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tables_CatalogDatabases_CatalogDatabaseId",
                        column: x => x.CatalogDatabaseId,
                        principalTable: "CatalogDatabases",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CatalogDatabases_Server_DatabaseName",
                table: "CatalogDatabases",
                columns: new[] { "Server", "DatabaseName" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tables_CatalogDatabaseId",
                table: "Tables",
                column: "CatalogDatabaseId");
